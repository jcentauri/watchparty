...
const gatewayHost = config_1.default.HETZNER_GATEWAY;
const sshKeys = [1570536];
const networks = config_1.default.HETZNER_NETWORKS.split(',').map(Number);
        ...
        this.startVM = (name) => __awaiter(this, void 0, void 0, function* () {
            const response = yield axios_1.default({
                ...
                data: {
                    ...
                    user_data: utils_1.cloudInit(utils_1.imageName, this.isLarge ? '1920x1080@30' : undefined, false, false, true),
                    labels: {
                        [this.getTag()]: '1',
                        originalName: name,
                    },
